...
import cu.uclv.postgrade.backend.service.UniversityService;
import cu.uclv.postgrade.backend.validation.Validation;
...
public class PersonForm extends FormLayout {
    ...
    public PersonForm(PersonService personService, UniversityService universityService){
        ...
        detailsFormLayout.add(years_experience, college_degree,  graduation_year, configureCollegeGraduate());
    ...
    private void configure(List<University> universities){
        ...
        phone.setSuffixComponent(new Icon(VaadinIcon.PHONE));
        emailField.setSuffixComponent(new Icon(VaadinIcon.ENVELOPE));
        fNameTextField.setSuffixComponent(new Icon(VaadinIcon.USER));
        lNameTextField.setSuffixComponent(new Icon(VaadinIcon.USER));
        idNumberTextField.setSuffixComponent(new Icon(VaadinIcon.USER_CARD));
        years_experience.setSuffixComponent(new Icon(VaadinIcon.CALENDAR_CLOCK));
        address.setSuffixComponent(new Icon(VaadinIcon.MAP_MARKER));
        graduation_year.setSuffixComponent(new Icon(VaadinIcon.ACADEMY_CAP));
    }
